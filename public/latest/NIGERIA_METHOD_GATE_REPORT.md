...
|---|---|---|---|---|
| `gdp_expenditure_2021_source_acquired` | `NOT_FOUND` | `NGA_NBS_ELIBRARY_REPORT_PAGE` | `` | The official NBS 2021 expenditure-GDP release was acquired. |
| `household_consumption_is_purpose_classified` | `NOT_FOUND` | `NGA_NBS_ELIBRARY_REPORT_PAGE` | `` | The report presents household consumption as an aggregate GDP-expenditure component, not twelve purposes. |
...
| `exact_armilar_source_available` | `NOT_FOUND` | `NGA_NBS_ELIBRARY_REPORT_PAGE` | `` | The reviewed official sources separate a 2021 aggregate national-accounts component from wrong-period household-survey detail; neither is an exact twelve-purpose matrix. |
