...
class RatificationProposalTests(unittest.TestCase):
    ...
    def test_target_constitution_is_unchanged_draft(self) -> None:
        ...
        self.assertEqual(materialization["upstream_raw_sha256"], "743e9b35b079b784ef9a2ccadf3a61ae267005a0f768313541b9ea2be671df83")
        self.assertEqual(materialization["constitutional_snapshot_sha256"], "51ed567c1eea6badd077d2bd1fe1f4009a7ce1b542e16971c79c389a4370042f")
        self.assertEqual(materialization["constitutional_snapshot_hash_policy"], "UTF8_WITHOUT_BOM_LF")
